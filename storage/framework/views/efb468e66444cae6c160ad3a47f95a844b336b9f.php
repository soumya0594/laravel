    ...
    <form class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-3 my-auto">
                <div class="form-group">
                    <div class="radio">
                        <label><input type="radio" name="optradio" checked> SC </label>
                        <label><input type="radio" name="optradio"> ST </label>
                        <label><input type="radio" name="optradio"> OBC </label>
                    </div>
                </div>
            </div>
            <div class="col-md-3">
        ...
        <div class="text-center pt-3 mb-5">
            <button class="btn btn-info mx-3"><i class="fas fa-eye px-3"></i>View</button>
...
<?php echo $__env->make('layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\resources\views/form.blade.php ENDPATH**/ ?>