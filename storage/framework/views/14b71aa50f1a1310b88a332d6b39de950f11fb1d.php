...
<div class="container">
    ...
    <div class="bg-info d-flex fs-5 rounded ">
        <div class="col-4 p-3 ">
            <a href="<?php echo e(url('dashboard/apply')); ?>" class="text-dark ">Application for SC/ST/OBC Certificate</a>
        </div>
...
<?php echo $__env->make('layouts.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\laravel\resources\views/dashboard/index.blade.php ENDPATH**/ ?>